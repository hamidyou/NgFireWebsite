export const NoteNamesInfo = {
  natural: ['A', 'B', 'C', 'D', 'E', 'F', 'G'],
  all: ['Abb', 'Ab', 'A', 'A#', 'Ax', 'Bbb', 'Bb', 'B', 'B#', 'Bx', 'Cbb', 'Cb', 'C', 'C#', 'Cx', 'Dbb', 'Db', 'D', 'D#', 'Dx', 'Ebb', 'Eb', 'E', 'E#', 'Ex', 'Fbb', 'Fb', 'F', 'F#', 'Fx', 'Gbb', 'Gb', 'G', 'G#', 'Gx'],
  majorKeys: ['Ab', 'A', 'Bb', 'B', 'Cb', 'C', 'C#', 'Db', 'D', 'Eb', 'E', 'F', 'F#', 'Gb', 'G'],
