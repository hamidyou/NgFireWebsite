...
@Injectable()
export class AllIntervalConstructionQuizSubmitService {
  ...
  quizSet(): void {
    ...
    this.postUnderQuiz = this.db.list('quizzes/AllIntervalConstructionQuiz/' + this.userFile.school + '/' + this.userFile.lastname + this.userFile.firstname);

    this.postUnderLastName = this.db.list('/quizzes/' + this.userFile.school + '/' + this.userFile.lastname + this.userFile.firstname + '/' + 'AllIntervalConstructionQuiz');
  ...
  submitScore(): void {
    if (this._IntervalConstructionQuizService.answerNotesCorrect < 15) {
      ...
      this.currentUser = this.db.object('users/' + this.userFile.school + '/' + this.userFile.program + '/' + this.userFile.lastname + this.userFile.firstname + '/quizScores/AllIntervalConstructionQuiz').take(1);
