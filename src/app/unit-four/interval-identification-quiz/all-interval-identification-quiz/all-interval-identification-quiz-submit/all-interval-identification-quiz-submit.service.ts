...
@Injectable()
export class AllIntervalIdentificationQuizSubmitService {
  ...
  quizSet(): void {
    ...
    this.postUnderQuiz = this.db.list('quizzes/AllIntervalIdentificationQuiz/' + this.userFile.school + '/' + this.userFile.lastname + this.userFile.firstname);

    this.postUnderLastName = this.db.list('/quizzes/' + this.userFile.school + '/' + this.userFile.lastname + this.userFile.firstname + '/' + 'AllIntervalIdentificationQuiz');
  ...
  submitScore(): void {
    if (this._intervalIdentificationQuizzesService.qualitiesCorrect < 15) {
      this.verify = 'This quiz cannot be submitted until you have 15 quantities and qualities correct. Please click' +
      ...
      this.currentUser = this.db.object('users/' + this.userFile.school + '/' + this.userFile.program + '/' + this.userFile.lastname + this.userFile.firstname + '/quizScores/AllIntervalIdentificationQuiz').take(1);
